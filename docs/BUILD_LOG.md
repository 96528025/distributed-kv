...
Day-by-day development record for the distributed KV store, kept for reference.
It is written in Chinese and is not part of the project's English documentation;
see the [README](../README.md) for the current architecture, verification and
run instructions.
